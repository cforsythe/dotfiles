...
copy_file "$DOTFILES_DIR/tmux/tmux_init"                     "$TARGET/.tmux_init"
...
echo "  3. git add users/$USERNAME && git add -f users/$USERNAME/.claude/"
echo "  4. git commit -m 'Update $USERNAME dotfiles'"
echo "  5. git push → Puppet deploys within ~2 hours"
print_warning ".claude/ requires 'git add -f' due to global .gitignore"
